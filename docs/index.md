...
OpenSirius is a research framework for composable, on-device AI systems.
...
OpenSirius is that stack. It is an opinionated framework for local-first personal AI, built around three core ideas: shared primitives for building on-device agents; evaluations that treat energy, FLOPs, latency, and dollar cost as first-class constraints alongside accuracy; and a learning loop that improves models using local trace data. The goal is simple: make it possible to build personal AI agents that run locally by default, calling the cloud only when truly necessary. OpenSirius aims to be both a research platform and a production foundation for local AI, in the spirit of PyTorch.
...
=== "Browser App"
    ...
    ```bash
    git clone https://github.com/open-jarvis/OpenSirius.git
    cd OpenSirius
...
=== "Desktop App"
    ...
    The desktop app is a native window for the OpenSirius UI.
    ...
    **Step 2.** Download and open the desktop app:
    ...
    [Download for macOS](https://github.com/open-jarvis/OpenSirius/releases/download/desktop-latest/OpenSirius_0.1.0_universal.dmg){ .md-button .md-button--primary }

    Also available for [Windows](https://github.com/open-jarvis/OpenSirius/releases/download/desktop-latest/OpenSirius_0.1.0_x64-setup.exe), [Linux (DEB)](https://github.com/open-jarvis/OpenSirius/releases/download/desktop-latest/OpenSirius_0.1.0_amd64.deb), and [Linux (RPM)](https://github.com/open-jarvis/OpenSirius/releases/download/desktop-latest/OpenSirius-0.1.0-1.x86_64.rpm). See the [Downloads](downloads.md) page for details.

    The app connects to `http://localhost:8000` automatically.

    !!! warning "macOS: run `xattr -cr /Applications/OpenSirius.app` if the app shows as \"damaged\"."
...
OpenSirius is built around five composable layers. Each has a clean interface and can be swapped independently.

1. **Intelligence** — Pick a model, or let OpenSirius pick one for your hardware. Manages the full catalog of local models across providers.
...
- **[Getting Started](getting-started/installation.md)**
  ...
  ***
  ...
  Install OpenSirius, configure your first engine, and run your first query.
...
@misc{saadfalcon2026openjarvis,
  title={OpenSirius: Personal AI, On Personal Devices},
